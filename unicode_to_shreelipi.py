...
def convertToshreelipi(source_text, filtered=False, debug=False):
    ...
    translated = translated.replace(u"ஐ", u"á")
    translated = translated.replace(u"ஒ", u"J")
    translated = translated.replace(u"ஓ", u"K")
    translated = translated.replace(u"ஔ", u"Jü")
    ...
    translated = translated.replace(u"ஜு", u"ã")
    ...
    translated = translated.replace(u"ணௌ", u"ön¯")
    ...
    translated = translated.replace(u"ணீ", u"n")
    ...
    translated = translated.replace(u"யௌ", u"¯")
    ...
    translated = translated.replace(u"றௌ", u"öÓÍ")
    ...
    translated = translated.replace(u"வௌ", u"öÁõ")
    ...
    translated = translated.replace(u"ஹா", u"íõ")
    translated = translated.replace(u"ஹ", u"í")
